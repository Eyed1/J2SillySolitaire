...
public class TensBoard extends Board {
    ...
    public boolean containsPairSum(List<Integer> selectedCards) {
        ...
        /*for (int i = 0; i < selectedCards.size(); ++i) {
            for (int j = i + 1; j < selectedCards.size(); ++j) {*/
                if (cards[selectedCards.get(0)].getValue() + cards[selectedCards.get(1)].getValue() == 10) {
                    return true;
                }
           /* }
        }*/
    ...
    public boolean containsE(List<Integer> selectedCards) {
        /* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
        if (selectedCards.size() < 4 || selectedCards == null) {
            return false;
        }

        if (cards[selectedCards.get(0)] == null || cards[selectedCards.get(1)] == null || cards[selectedCards.get(2)] == null || cards[selectedCards.get(3)] == null) {
            return false;
        }
        /*for (int i = 0; i < selectedCards.size(); ++i) {
            for (int j = i + 1; j < selectedCards.size(); ++j) {
                for (int k = j + 1; k < selectedCards.size(); ++k) {*/
                    if ((cards[selectedCards.get(0)].getRank().toString().equals("jack")  
                     && cards[selectedCards.get(1)].getRank().toString().equals("jack") 
                     && cards[selectedCards.get(2)].getRank().toString().equals("jack")
                     && cards[selectedCards.get(3)].getRank().toString().equals("jack"))
                     || (cards[selectedCards.get(0)].getRank().toString().equals("10")  
                     && cards[selectedCards.get(1)].getRank().toString().equals("10") 
                     && cards[selectedCards.get(2)].getRank().toString().equals("10")
                     && cards[selectedCards.get(3)].getRank().toString().equals("10"))
                     || (cards[selectedCards.get(0)].getRank().toString().equals("queen")  
                     && cards[selectedCards.get(1)].getRank().toString().equals("queen") 
                     && cards[selectedCards.get(2)].getRank().toString().equals("queen")
                     && cards[selectedCards.get(3)].getRank().toString().equals("queen"))
                     || (cards[selectedCards.get(0)].getRank().toString().equals("king")  
                     && cards[selectedCards.get(1)].getRank().toString().equals("king") 
                     && cards[selectedCards.get(2)].getRank().toString().equals("king")
                     && cards[selectedCards.get(3)].getRank().toString().equals("king"))) {
                        return true;
                    }
                /*}
            }
